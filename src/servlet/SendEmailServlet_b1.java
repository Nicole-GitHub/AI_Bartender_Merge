	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(act.equals("forgetpass_b1")) {
				...
				message.setContent("<font face=\"微軟正黑體\"><h2>您好:<br/>您已申請重新設置密碼功能，此郵件會協助您重新設置密碼。<br/>請使用下列連結進行密碼重置："
						+ "</h2></font><h2><font face=\\\"微軟正黑體\\\"><u><a href='"+request.getRequestURL()+"/../ForgetPassServlet_b1?email="+to+"'>"
