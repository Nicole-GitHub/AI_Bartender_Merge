					...
					<c:if test="${vs.index >= pageRow && vs.index < pageRow + 10}" >
						<tr style='background-color:${vs.index % 2 == 0 ? "#FFF" : "#FDEBE0" }' >
							...
							<td>
								<table>
									<tr>
										<td style="color:#648875"><label style="cursor:pointer;" onclick="location.href='WineDetail.jsp?id=${wine.id}'">${wine.enName}</label><br><br></td>
									</tr>
									<tr>
										<td style="color:#A56433"><label style="cursor:pointer;" onclick="location.href='WineDetail.jsp?id=${wine.id}'">${wine.chName}</label><br><br></td>
									</tr>
									<tr>
