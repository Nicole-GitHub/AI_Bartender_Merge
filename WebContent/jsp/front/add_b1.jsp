			...
			<div class="content">
					<div class="label">
						...
						<font face="微軟正黑體">
							...
							<input style="width:25vw;height:2vw" type="text" name="email"  id="email" placeholder="xxx@xxx.xxx"required="required"/></br></br>
							<label>姓名*</label></br>
							<input style="width:25vw;height:2vw" type="text" name="name" id="name" required="required"/></br></br>
							<label>密碼*</label></br>
							...
							<label>生日(須年滿十八歲)*</label></br>
							<input style="width:25vw;height:2vw" type="text" name="bday" id="bday"  placeholder="xxxx-xx-xx"required="required"/></br></br>
							<label>聯絡電話*</label></br>
							<input style="width:25vw;height:2vw" type="text" name="mobile"   id="mobile" pattern="^09\d{2}-?\d{3}-?\d{3}$" placeholder="09xx-xxx-xxx" required="required"/></br></br>
							<label>通訊地址*</label></br>
							<input style="width:25vw;height:2vw" type="text" name="address"  id="address" required="required"/></br></br>
