...
<div class="body content">
	<table width="700" height="100" border=0 align="center" valign="center">
		...
		<tr>
			<td width="70">
			<td id=ai colspan="2" align="center" valign="center"><a
				onclick="location.href='AiSommelier_c3.jsp'">進入AI侍酒師</td>

			<td id=shop colspan="2" align="center" valign="center"><a
				onclick="location.href='../../wineshop_b2'">直接逛酒窖</td>
			<td width="70">
		</tr>
	</table>
