...
<div id="age_gate"  >
	...
	<div class="btns"><img src="../../imgs/common/webImg-06.png" width="150" onclick="location.href='images_b2.jsp'">
	                  <img src="../../imgs/common/webImg-07.png" width="150" onclick="ageWarn()" ></div>
