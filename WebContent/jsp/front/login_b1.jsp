			...
			<div class="content">
				<div class="label">
					<font face="微軟正黑體">
						...
						<input style="width:25vw;height:2vw" type="text" id="email" name="email" placeholder="xxx@xxx.xxx"required="required"/>
						<br/><br/>
						<label>密碼*</label><br>
						<input style="width:25vw;height:2vw" type="password" id="password"required="required"/><br/><br/>
						...
						<div><input type="button" class="btn" onclick="login()" value="登入" /></div>
					</font>
				</div>
			</div>
		 </div>
